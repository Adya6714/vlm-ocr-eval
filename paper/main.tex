...
control is a model reported competent on real Devanagari scans
\citep{devanagari2026stresstest}, a single-author preprint rather than a
peer-reviewed result, on which position-resolved teacher-forced
...
All three, together with the positive control above, are inference-only
measurements requiring no further training. They were scoped out of the present
phase by available compute rather than by design, and the probe implementations
