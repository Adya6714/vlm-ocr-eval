...
than a scan corpus would present. Throughout, we write \emph{text-bearing} or \emph{real} for
evaluation images containing rendered text, in contrast to \emph{blank} white images; the
contrast is with an empty page, not with synthetic data.
...
benchmark's clean and degraded variants; the degraded variant simulates an aged document
through paper texture, ink wear, geometric distortion, downsampling and compression artifacts.
